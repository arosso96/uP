...
#include "..\isa.h"
	...
	SC_MODULE(DecodeStage) {
		...
		public:
			...
			void decode(unsigned int opcode, sc_uint<32> pc, sc_signal<sc_int<32>> *a, sc_signal<sc_int<32>> *b, sc_signal<execOpsT> *eO, sc_signal<memOpsT> *mO, sc_signal<wbOpsT> *wbO, sc_signal<sc_uint<5>> *wbRd) {
				printf("DECODE: ");
				sc_int<32> imm;
				sc_uint<5> rd;
				sc_uint<5> rs1, rs2;
